...
const MobileHeader = ({ sidebarOpen, setSidebarOpen, user }) => {
  ...
  const profilePhoto = user?.photoURL || "https://cdn-icons-png.flaticon.com/512/2922/2922506.png";
      ...
      <div className="mobile-user-section" ref={dropdownRef}>
        ...
        {menuOpen && (
          <div className="mobile-dropdown-menu">
            ...
            <div className="mobile-dropdown-divider"></div>
            <div className="mobile-dropdown-item mobile-logout-item" onClick={handleLogout}>
